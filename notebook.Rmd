...
In order to evaluate the model's predictive performance, which is one of the things that matters most according to the analysis problem section.
...
Now let's try another sensible but wider prior, while keeping results of the previous fit as our base-line.
