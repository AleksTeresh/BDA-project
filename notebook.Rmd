...
```{r}
loo_hierarchical_wide_prior <- get_loo_diagnostics(loo_hierarchical_wide_prior)
...
```{r}
loo_hierarchical_narrow_prior <- get_loo_diagnostics(loo_hierarchical_narrow_prior)
